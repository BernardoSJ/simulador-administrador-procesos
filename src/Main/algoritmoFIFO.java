...
//implements Runnable es la Interface que hace que los hilos funcionen como tal
public class algoritmoFIFO implements Runnable {
    ...
    //Metodo que contiene toda la logica del algoritmo
    public void iniciarFifo() throws InterruptedException {
        Procesos p;
