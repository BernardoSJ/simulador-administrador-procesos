 ...
 * @author Bernardo SJ
 */
public class algoritmoSJN implements Runnable {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(algoritmoSJN.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public void iniciarSJN() throws InterruptedException {
        Procesos p;
